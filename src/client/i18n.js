...
export const DICTIONARIES = {
  ...
  zh: ZH,
  'zh-TW': withEnglish({
    volcengineSettings: '火山引擎', volcengineSettingsTitle: '火山引擎 Provider', tabProvider: '火山 / 方舟 / 豆包', tabPortraits: '模型畫像', providerVolcengine: '火山方舟', providerDoubaoSpeech: '豆包語音', arkTitle: '方舟 · 語言 / 視覺語言模型', queryCatalog: '查詢可用模型', clearAll: '全部取消', add: '新增', searchModels: '搜尋模型', noMatchingModels: '沒有相符的模型。', saveArkWithCount: '儲存方舟設定（{count}）', saveArkNone: '儲存：全部不選', removeArk: '移除方舟', loadingArk: '正在載入方舟設定…', doubaoSpeech: '豆包語音', searchTaskModels: '搜尋任務模型', credentialReady: '憑據就緒', credentialMissing: '缺少憑據', saveSpeechWithCount: '儲存並註冊（{count}）', saveSpeechNone: '儲存：全部停用', testRealtime: '測試 Realtime 連線', portraitsTitle: '模型畫像', loadingPortraits: '正在載入模型畫像…', filterAll: '全部', filterEnabled: '已啟用', filterDisabled: '已停用', loadingConfig: '正在載入模型設定…', retry: '重試',
  }),
  ja: withEnglish({
