...
export async function prepareModelPortraits(ctx: Context, input: PrepareModelPortraitsInput, signal?: AbortSignal): Promise<Record<string, unknown>> {
  ...
  return {
    ...
    ontology: {
      ...
      routing: ['summary', 'specialties', 'limitations', 'bestFor', 'avoidFor', 'normalized qualityScores'],
      performance: ['speedClass', 'typical latency range', 'throughput and measurement context'],
